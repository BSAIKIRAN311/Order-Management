package com.order.service.management.exceptions;
...
public class GlobalControllerExceptionHandler extends ResponseEntityExceptionHandler 
{
	...
	private ResponseEntity<Object> getCustomExceptionResponse(WebRequest request, BaseException ex) {
		...
		try{
			...
			errorMessage = messageSourceUtil.getLocalisedText(com.order.service.management.constants.ExceptionConstants.GENERAL_ERROR_CODE, com.order.service.management.constants.ExceptionConstants.GENERAL_MODULE);
